...
* Continous Integration Servers: Jenkins, Concourse, Github Actions
* Infrastructure as code: Packer, Terraform
* Monitoring: Prometheus, Grafana
* Observability: Honeycomb, Opentracing
* Operating Systems: Linux, Windows, OSx
* Programming Langauges Proficient: Python, Golang
* Programming Langauges Basic: Ruby, Java, Groovy
* Source control: Git
...
* Maintaining and providing support for multiple Kubernetes clusters
* Implementing serivce mesh replacement from Linkerd 1 to Istio
